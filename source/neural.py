...
cnn.add(Dense(32, use_bias=True, activity_regularizer=keras.regularizers.l2(0.0001)))
cnn.add(Activation('relu'))
cnn.add(Dropout(0.25))

cnn.add(Dense(1, use_bias=True, activity_regularizer=keras.regularizers.l2(0.0001)))
...
cnn.fit(
    ...
    y = np.array([region["count"] for regions in training for region in regions])/5,
...
for img in open_images("../images/test_images"):
    ...
    for p in predictions: prediction += p*5
